...
//     this->radius = radius;
// }
// CollisionSphere::CollisionSphere(std::shared_ptr<Object> object, glm::vec3 position, float radius): Collision(object, position) {
//     this->radius = radius;
// }
// bool CollisionSphere::checkCollision(std::shared_ptr<CollisionSphere> other, CollisionInfo& info) {
