...
//     this->size = size;
// }
// CollisionBox::CollisionBox(std::shared_ptr<Object> object, glm::vec3 position, glm::vec3 size): Collision(object, position) {
//     this->size = size;
// }
...
//     return this->size;
// };
// bool CollisionBox::checkCollision(std::shared_ptr<CollisionBox> other, CollisionInfo& info) {
